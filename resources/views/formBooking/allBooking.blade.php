                        ...
                        <div class="table-responsive">
                            <table class="datatable table table-stripped table table-hover table-center mb-0">
                                ...
                                <tr>
                                    ...
                                    <td>
                                        <h2 class="table-avatar">
                                            <a href="profile.html" class="avatar avatar-sm mr-2"><img class="avatar-img rounded-circle" src="{{ \Illuminate\Support\Facades\URL::to('assets/img/profiles/avatar-03.jpg')}}" alt="User Image"></a>
                                ...
                                <tr>
                                    ...
                                    <td>
                                        <h2 class="table-avatar">
                                            <a href="profile.html" class="avatar avatar-sm mr-2"><img class="avatar-img rounded-circle" src="{{ \Illuminate\Support\Facades\URL::to('assets/img/profiles/avatar-04.jpg')}}" alt="User Image"></a>
                                ...
                                <tr>
                                    ...
                                    <td>
                                        <h2 class="table-avatar">
                                            <a href="profile.html" class="avatar avatar-sm mr-2"><img class="avatar-img rounded-circle" src="{{ \Illuminate\Support\Facades\URL::to('assets/img/profiles/avatar-05.jpg')}}" alt="User Image"></a>
                                ...
                                <tr>
                                    ...
                                    <td>
                                        <h2 class="table-avatar">
                                            <a href="profile.html" class="avatar avatar-sm mr-2"><img class="avatar-img rounded-circle" src="{{ \Illuminate\Support\Facades\URL::to('assets/img/profiles/avatar-06.jpg')}}" alt="User Image"></a>
                                ...
                                <tr>
                                    ...
                                    <td>
                                        <h2 class="table-avatar">
                                            <a href="profile.html" class="avatar avatar-sm mr-2"><img class="avatar-img rounded-circle" src="{{ \Illuminate\Support\Facades\URL::to('assets/img/profiles/avatar-07.jpg')}}" alt="User Image"></a>
                                ...
                                <tr>
                                    ...
                                    <td>
                                        <h2 class="table-avatar">
                                            <a href="profile.html" class="avatar avatar-sm mr-2"><img class="avatar-img rounded-circle" src="{{ \Illuminate\Support\Facades\URL::to('assets/img/profiles/avatar-08.jpg')}}" alt="User Image"></a>
    ...
    <div id="delete_asset" class="modal fade delete-modal" role="dialog">
        <div class="modal-dialog modal-dialog-centered">
            <div class="modal-content">
                <div class="modal-body text-center"> <img src="{{ \Illuminate\Support\Facades\URL::to('assets/img/sent.png')}}" alt="" width="50" height="46">
