...
<head>
    ...
    <link rel="stylesheet" href="{{\Illuminate\Support\Facades\URL::to('assets/css/style.css')}}"> <link rel="stylesheet" href="{{\Illuminate\Support\Facades\URL::to('assets/css/bootstrap.min.css')}}">
...
{{--                            <div class="form-group">--}}
                                <input id="email" placeholder="Email" type="email" placeholder="Email" class="form-control @error('email') is-invalid @enderror" name="email" value="{{ old('email') }}" required autocomplete="email" autofocus>
